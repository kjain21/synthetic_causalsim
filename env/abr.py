...
from env.trace_loader import load_chunk_sizes, sample_trace, load_traces
...
class ABRSimEnv(object):
    ...
    * REFERENCE *
    ...
    def __init__(self):
        ...
        self.extractor = torch.load('env/extractor.pth')
        self.predictor = torch.load('env/predictor.pth')
        self.buffer_mean = np.load('env/buffer_mean.npy')
        self.next_buffer_mean = np.load('env/next_buffer_mean.npy')
        self.buffer_std = np.load('env/buffer_std.npy')
        self.next_buffer_std = np.load('env/next_buffer_std.npy')
        self.chosen_chunk_size_mean = np.load('env/chosen_chunk_size_mean.npy')
        self.chosen_chunk_size_std = np.load('env/chosen_chunk_size_std.npy')
        self.download_time_mean = np.load('env/download_time_mean.npy')
        self.download_time_std = np.load('env/download_time_std.npy')
